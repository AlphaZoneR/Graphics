...
function drawFrame() {
  ...
  globalThis.gl.clearColor(0.5, 0.5, 0.5, 1);
...
function currentCurve(name) {
  const derivative = new RowMatrix(3);
  if (name === 'simple1') {
    derivative.set(0, simple1.d0);
    derivative.set(1, simple1.d1);
    derivative.set(2, simple1.d2);

    globalThis.parametricCurve = new ParametricCurve3(derivative, simple1.uMin, simple1.uMax);

    globalThis.genericCurve = globalThis.parametricCurve.generateImage(pointCountValue, gl.STATIC_DRAW);
    globalThis.genericCurve.updateVertexBufferObjects(gl.STATIC_DRAW);
  } else if (name === 'simple2') {
    derivative.set(0, simple2.d0);
    derivative.set(1, simple2.d1);
    derivative.set(2, simple2.d2);

    globalThis.parametricCurve = new ParametricCurve3(derivative, simple2.uMin, simple2.uMax);

    globalThis.genericCurve = globalThis.parametricCurve.generateImage(pointCountValue, gl.STATIC_DRAW);
    globalThis.genericCurve.updateVertexBufferObjects(gl.STATIC_DRAW);
  } else if (name === 'simple3') {
    derivative.set(0, simple3.d0);
    derivative.set(1, simple3.d1);
    derivative.set(2, simple3.d2);

    globalThis.parametricCurve = new ParametricCurve3(derivative, simple3.uMin, simple3.uMax);

    globalThis.genericCurve = globalThis.parametricCurve.generateImage(pointCountValue, gl.STATIC_DRAW);
    globalThis.genericCurve.updateVertexBufferObjects(gl.STATIC_DRAW);
  } else if (name === 'simple4') {
    derivative.set(0, simple4.d0);
    derivative.set(1, simple4.d1);
    derivative.set(2, simple4.d2);

    globalThis.parametricCurve = new ParametricCurve3(derivative, simple4.uMin, simple4.uMax);

    globalThis.genericCurve = globalThis.parametricCurve.generateImage(pointCountValue, gl.STATIC_DRAW);
    globalThis.genericCurve.updateVertexBufferObjects(gl.STATIC_DRAW);
  } else if (name === 'simple5') {
    derivative.set(0, simple5.d0);
    derivative.set(1, simple5.d1);
    derivative.set(2, simple5.d2);
    ...
    derivative.set(0, spiralOnCone.d0);
    derivative.set(1, spiralOnCone.d1);
    derivative.set(2, spiralOnCone.d2);

    globalThis.parametricCurve = new ParametricCurve3(derivative, spiralOnCone.uMin, spiralOnCone.uMax);
