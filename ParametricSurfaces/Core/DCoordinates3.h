...
namespace cagd
{
    ...
    public:
        ...
        friend inline const DCoordinate3 operator *(const GLdouble&, const DCoordinate3&);
    ...
    inline const DCoordinate3 DCoordinate3::operator -(const DCoordinate3& rhs) const
    {
        return DCoordinate3(this->_data[0] - rhs._data[0], this->_data[1] - rhs._data[1], this->_data[2] - rhs._data[2]);
    }
    ...
    inline DCoordinate3& DCoordinate3::operator ^=(const DCoordinate3& rhs)
    {
        this->_data[0] = this->_data[1] * rhs._data[2] - this->_data[2] * rhs._data[1];
        this->_data[1] = this->_data[2] * rhs._data[0] - this->_data[0] * rhs._data[2];
        this->_data[2] = this->_data[0] * rhs._data[1] - this->_data[1] * rhs._data[0];
    ...
    inline const DCoordinate3 DCoordinate3::operator /(const GLdouble& rhs) const
    {
        return DCoordinate3(this->_data[0] / rhs, this->_data[1] / rhs, this->_data[2] / rhs);
    }
